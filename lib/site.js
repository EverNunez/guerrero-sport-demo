...
export const CATEGORIAS = [
  ...
  { id: "cat-uniformes", nombre: "Uniformes deportivos", slug: "uniformes", descripcion: "Kits completos para equipos y clubes." },
  { id: "cat-conjuntos", nombre: "Conjuntos deportivos", slug: "conjuntos", descripcion: "Camiseta + short a juego." },
  { id: "cat-clubes", nombre: "Diseños para clubes", slug: "clubes", descripcion: "Identidad visual completa para tu club." },
  { id: "cat-arqueros", nombre: "Camisetas de arquero", slug: "arqueros", descripcion: "Indumentaria de guardameta." },
...
export const PRODUCTOS = [
  ...
  {
    id: "prod-2",
    nombre: "Conjunto Guerrero Sport",
    descripcion: "Kit completo camiseta + short con la identidad Guerrero Sport. Ideal para tu plantel.",
    etiqueta: "Kit completo",
    categoria: "conjuntos",
    precio: "",
    base: "royal",
    numero: "07",
    imagen: `${IMG_CAT}/conjunto-guerrero-sport.webp`,
    visible: true,
  },
  {
    id: "prod-3",
  ...
  {
    id: "prod-4",
    nombre: "Camiseta edición Espartano",
    descripcion: "Sublimado full color de alto impacto con la temática guerrera de la marca.",
    etiqueta: "Premium",
    categoria: "sublimados",
    precio: "",
    base: "carbon",
    numero: "01",
    imagen: `${IMG_CAT}/camiseta-espartano.webp`,
    visible: true,
  },
  {
    id: "prod-5",
    ...
    base: "gold",
    numero: "11",
    imagen: `${IMG_CAT}/camiseta-franco-amarillo.webp`,
    visible: true,
  },
  {
    id: "prod-6",
...
export const GALERIA = [
  { id: "gal-1", titulo: "Edición Espartano", tipo: "Sublimado premium", base: "carbon", numero: "01", span: "lg:col-span-2 lg:row-span-2", imagen: `${IMG_GAL}/galeria-espartano.webp`, visible: true },
  { id: "gal-2", titulo: "Conjunto Espartano", tipo: "Kit completo", base: "carbon", numero: "10", span: "", imagen: `${IMG_GAL}/galeria-espartano-conjunto.webp`, visible: true },
  { id: "gal-3", titulo: "Sublimado neón", tipo: "Diseño a medida", base: "spartan", numero: "07", span: "", imagen: `${IMG_GAL}/galeria-sublimada-rosa.webp`, visible: true },
  { id: "gal-4", titulo: "Club Franco", tipo: "Uniforme completo", base: "gold", numero: "11", span: "lg:col-span-2", imagen: `${IMG_GAL}/galeria-franco-conjunto.webp`, visible: true },
  { id: "gal-5", titulo: "Diseño ñandutí", tipo: "Identidad nacional", base: "royal", numero: "09", span: "", imagen: `${IMG_GAL}/galeria-nanduti.webp`, visible: true },
  { id: "gal-6", titulo: "Edición Barça", tipo: "Personalizado", base: "royal", numero: "10", span: "", imagen: `${IMG_GAL}/galeria-barcelona.webp`, visible: true },
  { id: "gal-7", titulo: "Sublimado verde", tipo: "Diseño deportivo", base: "carbon", numero: "08", span: "", imagen: `${IMG_GAL}/galeria-sublimada-verde.webp`, visible: true },
  { id: "gal-8", titulo: "Línea Guerrero", tipo: "Camiseta institucional", base: "carbon", numero: "GS", span: "", imagen: `${IMG_GAL}/galeria-gris-logo.webp`, visible: true },
  { id: "gal-9", titulo: "Raza Guaraní", tipo: "Diseño especial", base: "spartan", numero: "10", span: "", imagen: `${IMG_GAL}/galeria-raza-guarani.webp`, visible: true },
  { id: "gal-10", titulo: "Degradado verde", tipo: "Sublimado", base: "royal", numero: "07", span: "", imagen: `${IMG_GAL}/galeria-verde-degradado.webp`, visible: true },
  { id: "gal-11", titulo: "Diseño Garras", tipo: "Edición agresiva", base: "spartan", numero: "09", span: "lg:col-span-2", imagen: `${IMG_GAL}/galeria-garras.webp`, visible: true },
];
